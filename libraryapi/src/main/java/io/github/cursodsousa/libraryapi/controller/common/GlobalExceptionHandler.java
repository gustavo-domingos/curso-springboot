...
import io.github.cursodsousa.libraryapi.exceptions.CampoInvalidoExceptions;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(OperacaoNaoPermitidaExcepiton.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ErroResposta handleOperacaoNaoPermitidaExcepiton(OperacaoNaoPermitidaExcepiton e){
        return ErroResposta.respostaPadrao(e.getMessage());
    }

    @ExceptionHandler(CampoInvalidoExceptions.class)
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public ErroResposta handleCampoInvalidoException(CampoInvalidoExceptions e){
        return new ErroResposta(
                HttpStatus.UNPROCESSABLE_ENTITY.value(),
                "Erro de validação.",
